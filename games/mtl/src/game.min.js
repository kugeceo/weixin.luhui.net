		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://weixin.luhui.net";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://weixin.luhui.net";
y.url = function() {
	return "http://weixin.luhui.net?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://weixin.luhui.net/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
