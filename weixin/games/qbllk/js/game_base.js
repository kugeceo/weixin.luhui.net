if (void 0 == APP_BASE_URL) var APP_BASE_URL = "http://weixin.luhui.net/";
if (void 0 == GAME_LIST_URL) var GAME_LIST_URL = "http://weixin.luhui.net/";
if (void 0 == FOLLOW_URL) var FOLLOW_URL = "http://weixin.luhui.net/";
var BASE_RES_DIR = "../",
	RES_DIR = "",
	APP_DEPLOYMENT = "WEB",
	USE_NATIVE_SOUND = !1,
	...
	SHOW_COPYRIGHT = !1,
	IN_WEIXIN = !1;
0 <= document.URL.indexOf("file://") && (IS_ANDROID || IS_IOS) && (APP_DEPLOYMENT = "APP", USE_NATIVE_SOUND = USE_NATIVE_SHARE = !0, APP_BASE_URL = "http://weixin.luhui.net/");
...
window.shareData = {
    "imgUrl": "http://weixin.luhui.net/icon/qbllk.png",
    "timeLineLink": "http://weixin.luhui.net/games/qbllk/",
    "tTitle": "奇葩连连看-168源码",
