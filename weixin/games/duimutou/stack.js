...
var tite="";
	var DFW = {
		appId: "",
		TLImg: "http://weixin.luhui.net/games/duimutou/icon.png",
		url: "http://weixin.luhui.net/games/duimutou/",
...
function updateShare(stscore) {
	imgUrl = 'http://weixin.luhui.net/games/duimutou/i/icon.png';
	lineLink = 'http://weixin.luhui.net/games/duimutou';
