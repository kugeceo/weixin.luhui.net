...
;~function(bt){
	...
	bt.URL = {
		root: "http://weixin.luhui.net"
		,getMoreGame: function(){
			// 点击更多
			bt.dc("more");
			
			return "http://weixin.luhui.net";
		}
		,getConcern: function(){
			return "http://mp.weixin.qq.com/s?__biz=MzA3NDAzMDM1NQ==&mid=206737323&idx=1&sn=1262b615aef64af4349a9a76f92df7d6&scene=18#rd";
		}
...
;~function(bt){
	...
	var dataForWeixin={
	   ...
	   width:"66",
	   src: "img/icon.png",
	   //src: "http://weixin.luhui.net/sjm/icon.png",
	   url:"/",
