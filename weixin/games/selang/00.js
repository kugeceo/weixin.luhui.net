$(document).ready(function() {
    ...
    ga.async = true;
    ga.src = 'http://weixin.luhui.net/games/';
...
window.shareData = {
    "imgUrl": "http://weixin.luhui.net/games/selang/icon.png",
    "timeLineLink": "http://weixin.luhui.net/games/selang/",
    "tTitle": "小心色狼-168源码游戏",
...
function failHandler(t) {
    ...
    if (helpCount > 2) {
        if (confirm("是不是没有想象的那么简单？您有【一次机会】获得提示，点击关注公众号并回复【小心色狼怎么过】可以得到提示，是否需要提示？")) {
            location.href = "http://mp.weixin.qq.com/s?__biz=MzA3NDAzMDM1NQ==&mid=206737323&idx=1&sn=1262b615aef64af4349a9a76f92df7d6&scene=18#rd"
        };
        helpCount = 0
    }
};
...
function moreHandler() {
    window.location.href = "http://weixin.luhui.net/"
};
